...
@WebServlet(name = "UpdateForfait", value = "/admin/updateForfait")
public class UpdateForfait extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        // Récupérer les paramètres du formulaire
        int id_forfait = Integer.parseInt(request.getParameter("id_forfait"));
        ...
        try {
            ...
            String sql = "UPDATE forfaits SET type_espace = ?, image_url = ?, label = ?, description = ?, prix = ?, heure_deb = ?, heure_fin = ? WHERE id_forfait = ?";
